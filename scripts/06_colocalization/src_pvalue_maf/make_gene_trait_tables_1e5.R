...
GWAS_file <- args[["file"]]
#GWAS_file<-"/lustre/home/hchen/2021-10-31-cancer-GWAS/aQTL_coloc/output/GWASs/CG0052/GLGC_CG0052_result.txt"
Trait <- args[["trait"]]
#Trait<-"CG0052"
eQTL_directory <- args[["eQTL_dir"]]
#eQTL_directory <-"/lustre/home/hchen/2021-10-31-cancer-GWAS/aQTL_coloc/output/aQTLs_transcript_hg19/Cells_Cultured_fibroblasts/" 
tiss<-strsplit(eQTL_directory,'/')[[1]][9]
sentinal_file <- args[["sentinal_file"]]
#sentinal_file <- "/lustre/home/hchen/2021-10-31-cancer-GWAS/coloc_analysis/output/sentinelSNP/CG0052/sentinalSNP.txt"
...
write.table(gene_trait_tss,file=paste(Trait,tiss,"sentinel_100kb.list",sep="_"),quote=F)
